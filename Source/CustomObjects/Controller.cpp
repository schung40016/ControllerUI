...
Controller::Controller(float inp_size, std::string inp_controllerName, DirectX::SimpleMath::Vector2 inp_position)
{
    ...
    Triangle a = Triangle(sControllerName + "_a", DirectX::Colors::HotPink, temp_gamePad, 1.f, 159.f, 38.f, 40.f, 40.f);
    Triangle b = Triangle(sControllerName + "_b", DirectX::Colors::HotPink, temp_gamePad, 1.f, 199.f, 80.f, 40.f, 40.f);
    Triangle x = Triangle(sControllerName + "_x", DirectX::Colors::HotPink, temp_gamePad, 1.f, 119.f, 80.f, 40.f, 40.f);
    Triangle y = Triangle(sControllerName + "_y", DirectX::Colors::HotPink, temp_gamePad, 1.f, 159.f, 120.f, 40.f, 40.f);
